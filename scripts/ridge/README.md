...
- `plot_ridge_population.py` — population-level ridge summaries across sound × subregion × window.
...
2. Subsample to exactly 30 neurons, repeated 100× with different seeds.
...
6. Score = mean R² across folds, averaged over the 100 subsamples.
