...
#%% Actual population calculations - PopulationEvoked firing speech
FTParamsEachTrial = bdataSpeech['targetFTpercent']
possibleFTParams = np.unique(FTParamsEachTrial)
nTrials = len(FTParamsEachTrial)
...
plt.title("PopulationEvoked firing rate averaged across ALL speech trials")
...
plt.legend(["Spontaneous", "PopulationEvoked"], loc="best")
