...
Processing
- Load and preprocess neural data for all subjects and dates
...
Outputs
- DataFrame of average R² values per brain area, sound type, and subject
...
for key, value in data_dict.items():
    ...
    if key[0] == "Primary auditory area":
        params.primary_n_neurons += n_neurons
    elif key[0] == "Dorsal auditory area":
        params.dorsal_n_neurons += n_neurons
    else:
        params.ventral_n_neurons += n_neurons
