"""
Purpose
- Ridge regression across subjects, brain areas, and sound types (PT, AM, speech)
- Subsample neurons to have equal counts across conditions
- Perform Ridge regression over multiple alphas to find best test R²

Inputs
- Spike-rate arrays (neurons × trials) for each subject, brain area, and sound type
- Corresponding stimulus frequencies for PT, AM, and speech
- Trial equalization parameters, neuron subsampling thresholds, and random seed

Processing
- Load and preprocess neural data for all subjects and recording dates
- Log-transform frequencies for AM and PT stimuli
- Compute average R² per subject × brain area × sound type

Outputs
- DataFrame of test R² values per subject, brain area, and sound type
- Boxplot of R² distributions with color mappings for brain areas and sound types
"""
