...
# %% Constants
figSavePath = "/Users/zoetomlinson/Desktop/MurrayLab/figures/SingleMouse"
...
fullPath = os.path.join(params.databaseDir, fullDbPath)
...
frequency_counts_dict = {tuple(freq): [] for freq in params.unique_labels}
