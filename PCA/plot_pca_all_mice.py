...
# counts2022 = fullDb2022.groupby('recordingSiteName').size()
...
# Create a 3x3 grid for 2D PCA subplots
y_max = 0.12
fig_pca_subset119, axes_pca = plt.subplots(3, 3, figsize=(22, 16))
fig_pca_subset119.suptitle('2D PCA Plots for Different Brain Areas and Sound Types - Subset to 111 neurons', fontsize=16)
fig_pca_subset119.subplots_adjust(hspace=0.4, wspace=0.4)
